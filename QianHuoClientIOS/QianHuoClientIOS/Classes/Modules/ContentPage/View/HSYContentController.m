...
@property (nonatomic, strong) UIBarButtonItem *isLikeItem;
...
- (void)setupToolbar {
    ...
    self.isLikeBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, imgViewH, imgViewH)];
    ...
    self.isLikeBtn.selected = self.isLike;
    self.isLikeItem = [[UIBarButtonItem alloc] initWithCustomView:self.isLikeBtn];
    ...
    NSArray *items = @[self.backItem, self.forwardItem, spaceItem, self.isLikeItem, spaceItem, refreshItem];
